      ...
      <main className="flex-1 ml-64">
        <article className="max-w-4xl mx-auto px-8 py-12">
          ...
          <div className="text-sm text-[var(--text-secondary)] mb-2">
            МОДУЛЬ 3: МЕТОДОЛОГИЯ ВАЙБ-КОДИНГА • Урок 2 из 4
          </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p>
              В следующем уроке разберём CLAUDE.md — специальный файл, где живут твои постоянные правила для агента. Написал один раз — Claude помнит их во всех чатах и никогда не забывает.
            </p>
