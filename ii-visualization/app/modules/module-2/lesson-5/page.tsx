      ...
      <main className="flex-1 ml-64">
        <article className="max-w-4xl mx-auto px-8 py-12">
          ...
          <div className="text-sm text-[var(--text-secondary)] mb-2">
            МОДУЛЬ 2: КАК РАБОТАТЬ С CLAUDE CODE • Урок 5 из 5
          </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p>
              В Модуле 3 разберём методологию вайб-кодинга — правило 80/20, документацию СНАЧАЛА, файл CLAUDE.md с постоянными правилами и что делать, когда всё пошло не так. Это дисциплина, которая отделяет результат от хаоса.
            </p>
