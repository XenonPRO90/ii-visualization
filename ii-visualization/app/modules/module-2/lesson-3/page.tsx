      ...
      <main className="flex-1 ml-64">
        <article className="max-w-4xl mx-auto px-8 py-12">
          ...
          <div className="text-sm text-[var(--text-secondary)] mb-2">
            МОДУЛЬ 2: КАК РАБОТАТЬ С CLAUDE CODE • Урок 3 из 5
          </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p>
              В следующем уроке научимся давать Claude визуальный контекст — показывать скриншоты ошибок, макетов, результатов. Одна картинка часто решает быстрее, чем десять абзацев описания.
            </p>
