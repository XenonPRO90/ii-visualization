      ...
      <main className="flex-1 ml-64">
        <article className="max-w-4xl mx-auto px-8 py-12">
          ...
          <div className="text-sm text-[var(--text-secondary)] mb-2">
            МОДУЛЬ 0: УСТАНОВКА • Урок 7 из 7
          </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p>
              В Модуле 1 копаем глубже. Как устроен интерфейс Claude Code. Как говорить с агентом, чтобы он делал ровно то, что нужно. Почему документация важнее кода. Правило 80/20 и вайб-кодинг как процесс.
            </p>
