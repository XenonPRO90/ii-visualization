      ...
      <main className="flex-1 ml-64">
        <article className="max-w-4xl mx-auto px-8 py-12">
          ...
          <div className="text-sm text-[var(--text-secondary)] mb-2">
            МОДУЛЬ 0: УСТАНОВКА • Урок 5 из 5
          </div>
...
Напиши там, что это учебный проект для изучения Claude Code.`}
            ...
            <p>
              Отлично! Модуль 0 завершен. Ты установил все инструменты и создал первый проект.
            </p>
            ...
            <div className="bg-[var(--bg-secondary)] p-6 rounded-lg my-6">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>✅ Как установить VS Code</li>
                <li>✅ Как установить AquaVoice</li>
                <li>✅ Как установить Claude Code</li>
                <li>✅ Как создать первый проект</li>
                <li>✅ Как общаться с Claude голосом</li>
              </ul>
            </div>

            <p>
              В следующем модуле мы глубже погрузимся в работу с Claude Code:
            </p>

            <ul className="space-y-2">
              <li>• Разберем интерфейс</li>
              <li>• Научимся правильно формулировать запросы</li>
              <li>• Узнаем про правило 80/20 (исследование vs разработка)</li>
              <li>• Поймем, как создавать документацию СНАЧАЛА</li>
            </ul>
