# URL: https://aizdec.me/courses/claude-code/why-documentation
# Title: Зачем документация | ИИздец
...
Всё что можешь нагрести и собрать — складывай в проектную документацию. Это твоя база знаний, к которой ты и Claude будете возвращаться на разных этапах работы. С этого ты начнёшь в следующем уроке.
...
Техническую документацию пишут перед внедрением каждой новой фичи. Ты описываешь что хочешь, можешь попросить Claude поискать как это сделано у других — и только потом начинаешь разработку. Это понадобится позже, когда начнёшь разрабатывать проект.
...
Что должно быть? (3-5 главных функций)

Чего НЕ будет? (что не делаем, хотя бы пока)
