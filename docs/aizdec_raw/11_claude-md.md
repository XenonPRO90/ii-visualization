# URL: https://aizdec.me/courses/claude-code/claude-md
# Title: Файл CLAUDE.md | ИИздец
...
Напиши /init — посмотри что Claude предложит

Добавь своё правило через клавишу #

Проверь что файл появился в корне проекта

Попробуй нарушить правило — Claude должен отказаться или спросить
